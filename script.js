...
var getQuestion = function () {
  questionNumEl.innerHTML = questionArray[0].questionNum;
  questionEl.innerHTML = questionArray[0].question;
  choice1El.innerHTML = questionArray[0].choice1;
  choice2El.innerHTML = questionArray[0].choice2;
  choice3El.innerHTML = questionArray[0].choice3;
  choice4El.innerHTML = questionArray[0].choice4;
};
...
var displayQuestion = function () {
  ...
  if (this.innerHTML === questionArray[0].correctAnswer) {
...
var nextQuestion = function () {
  for (var i = 0; i < questionArray.length; i++) {
    if (this.innerHTML === questionArray[i].correctAnswer) {
      this.innerHTML = "CORRECT";
      this.setAttribute("style", "background-color: #00FF00");
      score += 10;
      scoreEL.innerHTML = "SCORE: " + score;
      console.log("your score is " + score);
      questionNumEl.innerHTML = questionArray[i].questionNum;
      questionEl.innerHTML = questionArray[i].question;
      choice1El.innerHTML = questionArray[i].choice1;
      choice2El.innerHTML = questionArray[i].choice2;
      choice3El.innerHTML = questionArray[i].choice3;
      choice4El.innerHTML = questionArray[i].choice4;
      nextQuestion();
    } else {
      console.log("incorrect");
      secondsLeft -= 5;
